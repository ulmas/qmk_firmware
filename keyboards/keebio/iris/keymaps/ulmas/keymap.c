...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
        ...
        KC_LSFT       , KC_Z , KC_X  , KC_C   , KC_V , KC_B          , _______, _______, KC_N, KC_M, KC_COMM, KC_DOT , TD(0), RSFT_T(KC_ENT),
        KC_LGUI       , MO(1), KC_SPC, KC_BSPC, MO(2), LALT_T(KC_DEL)
        ),
	[1] = LAYOUT(
        KC_TILD, _______ , _______, _______, _______, KC_LT  , KC_GT  , KC_PSLS, KC_PAST, KC_PAST, KC_PMNS, KC_MINS,
